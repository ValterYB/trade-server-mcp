...
import {
  ...
  forceDeleteOrderSchema, forceDeleteOrder,
  getAccountSummarySchema, getAccountSummary,
...
import {
  ...
  getIndicatorSchema, getIndicator,
...
import {
  ...
  addRoutingRuleSchema, addRoutingRule,
  removeRoutingRuleSchema, removeRoutingRule,
...
function toolHandler<T>(
  ...
  return async (params: T) => {
    try {
      ...
      return { content: [{ type: "text" as const, text: JSON.stringify(errorResponse) }], isError: true };
    }
  };
}
...
async function main() {
  ...
  server.resource(
    ...
    async () => {
      ...
      return { contents: [{ uri: "trade://symbols", text: JSON.stringify(result, null, 2), mimeType: "application/json" }] };
    }
  );
  ...
  server.resource(
    ...
    async () => {
      ...
      return { contents: [{ uri: "trade://groups", text: JSON.stringify(result, null, 2), mimeType: "application/json" }] };
    }
  );
  ...
  server.resource(
    ...
    async () => {
      ...
      return { contents: [{ uri: "trade://accounts", text: JSON.stringify(result, null, 2), mimeType: "application/json" }] };
    }
  );
  ...
  server.resource(
    ...
    async () => {
      ...
      return { contents: [{ uri: "trade://connectors", text: JSON.stringify(result, null, 2), mimeType: "application/json" }] };
    }
  );
