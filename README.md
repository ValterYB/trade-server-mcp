...
| **30 trader tools / 98 broker tools** | Task-shaped tools covering trading, account monitoring, market data, and (admin) server configuration, plus MCP resources for static context |
...
| **Tools / resources** | 30 tools, 1 resource | 98 tools, 4 resources |
...
│   ├── register-admin.ts      # Registers the 98 admin tools + 4 resources
