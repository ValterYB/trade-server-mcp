...
connectors, and use the full market-data toolset — 132 tools with server-wide scope. You need
...
- [Configuration](./CONFIGURATION.md) — every environment variable, all config examples, every
  startup message
- [Tools Reference](./TOOLS_REFERENCE.md) — all 30 client tools and 132 admin tools in detail
